    ...
    <div className="relative inline-block">
      ...
      {showControl && (
        <button
          ...
          className="absolute top-2 right-2 p-1.5 rounded-md border border-border bg-surface text-text-primary hover:bg-surface-alt transition-colors focus:outline-hidden"
        >
